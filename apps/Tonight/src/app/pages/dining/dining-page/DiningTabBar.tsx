    ...
    <div role="tablist" aria-label="Dining booking status" className="sticky top-2 z-10 -mx-1 rounded-[1.5rem] bg-background/90 px-1 py-2 backdrop-blur-md">
      <div className="flex w-full gap-2 overflow-x-auto pb-1">
        {DINING_TABS.map((tab: DiningTabOption) => {
          ...
          const visualLabel = tab.shortLabel;
          ...
          return (
            <motion.button
              ...
              className={`flex h-10 min-w-[6.6rem] cursor-pointer items-center justify-center gap-1 rounded-full px-2 transition active:scale-95 ${
                active
