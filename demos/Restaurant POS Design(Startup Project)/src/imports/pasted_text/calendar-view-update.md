Here's a prompt you can drop into your coding workflow to update the Calendar View. I've set the extension increment to 30 minutes as you specified (updating from the 15-min value in the earlier spec).
...
That should give your coding assistant enough to implement it cleanly. Let me know if you want the prompt adjusted for a specific framework (React, Vue, etc.) or if you'd like me to break it into smaller incremental prompts for a staged rollout.