...
function TabButton({ tab, isActive, onSelect, badgeCount }: {
  tab: (typeof TABS)[number]; isActive: boolean; onSelect: () => void; badgeCount?: number;
}) {
...
export function AppLayout() {
  ...
  const hideTopBar = /^\/(saved|notifications)/.test(location.pathname);
